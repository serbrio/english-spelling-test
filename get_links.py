...
class GetLinks:
	...
	def get_links(cls, words):
		"""
		In parallel executes method GetLinks.get_link() for every word in "words".
		Returns a dictionary with found links as values 
		and corresponding words as keys,
		and a list of words, for which links were not found.
		"""
		words_links = {}
		notfound_words = []
